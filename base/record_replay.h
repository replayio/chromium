...
void OnMouseEvent(const char* kind, size_t clientX, size_t clientY, bool synthetic = false);
void OnKeyEvent(const char* kind, const char* key, bool synthetic = false);
