...
void LocalFrameMojoHandler::RecordReplayRegisterAuthTokenObserver() {
  // include this extra is_bound() check to make sure we only register the
  // observer once.
  if (auth_token_store_.is_bound()) {
    return;
  }
