...
class CORE_EXPORT DevToolsAgent : public GarbageCollected<DevToolsAgent>,
 ...
 private:
  ...
  HeapHashSet<Member<DevToolsSession>, blink::MemberHashRecordReplayId<DevToolsSession>> sessions_;
  scoped_refptr<InspectorTaskRunner> inspector_task_runner_;
  scoped_refptr<base::SingleThreadTaskRunner> io_task_runner_;
  HashMap<WorkerThread*,
          std::unique_ptr<WorkerData>,
          blink::RawPtrHashRecordReplayRegisteredPointerId<WorkerThread>>
