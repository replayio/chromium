...
String ReadReplaySourcemapsScript() {
  return ReadReplayAssetFile("replay_sourcemaps.js");
}

String ReadReplayReactDevtoolsScript() {
  return ReadReplayAssetFile("replay_react_devtools.js");
}

String ReadReplayReduxDevtoolsScript() {
  return ReadReplayAssetFile("replay_redux_devtools.js");
}
...
static void InitializeReplayScripts(v8::Isolate* isolate, LocalFrame* localFrame, v8::Local<v8::Context> context) {
  ...
  if (recordreplay::FeatureEnabled("collect-source-maps") &&
    ...
    RunScript(isolate, context, ReadReplaySourcemapsScript(), InternalScriptURL);
  }
...
void OnRootFrameInitAfterCheckpoint(v8::Isolate* isolate, LocalFrame* localFrame, v8::Local<v8::Context> context) {
  ...
  if (recordreplay::FeatureEnabled("react-devtools-backend") &&
    ...
    // its frames.
    RunScript(isolate, context, ReadReplayReactDevtoolsScript(), "record-replay-react-devtools");
    RunScript(isolate, context, ReadReplayReduxDevtoolsScript(), "record-replay-redux-devtools");
  }
}
